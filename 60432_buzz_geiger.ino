...
#define TMR1_INT_FREQ   25
#define TMR1_PRESCALER  1024
#define TIMER1_PRELOAD  (65536-(F_CPU/TMR1_PRESCALER)/TMR1_INT_FREQ)
...
#define BUZZ_OUT   (bitSet(BUZZ_DDR, BUZZ_BIT))
//-----------------------------------------------------------------------------
...
TCCR1B=0b00000101; //предделитель 16000000/1024=15625Гц
...
//-----------------------------------------------------------------------------
void buzz_pulse(void) //a single pulse to buzzer
	{
	BUZZ_SET;
	_delay_us(50);
	BUZZ_CLR;
